    ...
    <div className="w-full">
      ...
      <div className={`fixed z-20 w-full transition-colors duration-1000 ${getNavbarClasses()}`}>
        <Navbar>
          <ScrollLink
            to="home"
            className="cursor-pointer w-[50%] phone2:w-[50%] phone3:w-[45%] tablet1:w-[30%] tablet2:w-[30%] desktop1:w-[25%] desktop2:w-[340px]"
            spy={true}
            smooth={true}
            duration={500}
            offset={-100}
          ...
          >
            <img
              ...
              className={`bg-transparent ${
                scrolling
                  ? "w-[90%] tablet1:w-[80%] tablet2:w-[70%] desktop1:w-[80%] desktop2:w-[60%]"
                  : "my-[20px] w-full"
